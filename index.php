...
<html>
	...
	<div>
	  <p class="text-center"><a class="btn btn-large btn-primary" href="http://localhost/sistempakar/" role="button">Menu Utama</a></p>
        </div>
	<div>
	  <footer class="navbar-fixed-bottom">
	  <hr>
		<p  style="padding-left:70px;"><center>&copy; Sistem Pakar Kartu Kredit Mandiri 2020 </center></p>
	  </footer>
	</div> <!-- /container -->
	</body>
</html>