	...
	<div class="navbar  navbar-fixed-top">
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <a class="brand" href="#">Hotel Azana Sapta Nawa</a>
		  <div class="nav-collapse collapse">
			<ul class="nav">
			  <li class="active"><a href="admin.php?home">Home</a></li>
			  <li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Jenis <b class="caret"></b></a>
				<ul class="dropdown-menu">
				  <li><a href="artikel.php?data">Data Jenis Pelayanan</a></li>
				  <li><a href="artikel.php?entri">Entri Jenis Pelayanan</a></li>
				</ul>
			  </li>
			  <li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Kriteria <b class="caret"></b></a>
				<ul class="dropdown-menu">
				  <li><a href="gejala.php?data">Data Kriteria</a></li>
				  <li><a href="gejala.php?entri">Entri Kriteria</a></li>
				</ul>
			  </li>
			  <li class="dropdown">
			  ...
			  <li class="dropdown">
				...
				<ul class="dropdown-menu">
				  <li><a href="lap.php?diagnosa" target="_blank">Laporan Data Pemesanan</a></li>
				  <li><a href="lap.php?gejala" target="_blank">Laporan Data Kriteria</a></li>
				  <li><a href="lap.php?solusi" target="_blank">Laporan Data Solusi</a></li>
				</ul>
			  </li>
